...
public class ImageUtils {
    ...
    // do not fix this color list, it will make images transparent, the first 4 colors are wrong
    ...
    static {
        colormodel = createCustomColorModel(colorslist);
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < 1; i++) {
            a = (ImageIO.read(new File("C:/Users/sacha/Downloads/download (1).jpg")));
        }
        final long endTime = System.currentTimeMillis();
        ConvertAndWriteMinecraftImage(a, new File("C:/Users/sacha/Downloads/p123.png"));
    ...
    public static void ConvertAndWriteMinecraftImage(BufferedImage image, File out) throws IOException {
        BufferedImage mcimage = ImageToMinecraftImage(image);
        ...
        writer.write(null, new javax.imageio.IIOImage(mcimage, null, null), param);
        ios.close();
        writer.dispose();
    }


    public static BufferedImage ImageToMinecraftImage(@NotNull BufferedImage image) {
