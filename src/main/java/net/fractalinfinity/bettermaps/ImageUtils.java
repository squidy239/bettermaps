...
public class ImageUtils {
    ...
    public  static void main(String[] args) throws IOException {
        ...
        @NotNull BufferedImage a = null;
        final long startTime = System.currentTimeMillis();
        for (int i = 0; i < 100; i++) {;a = imageToimageBytes((ImageIO.read(new File("C:/Users/sacha/Downloads/download (1).jpg"))));}
        final long endTime = System.currentTimeMillis();
        ImageIO.write(a,"png",new File("C:/Users/sacha/Downloads/p123.png"));
    ...
    public static @NotNull BufferedImage imageToimageBytes(@NotNull BufferedImage image) {
        ...
        for(int i = 0; i < pl; i++){
            ...
            pixels[i] = colorcache[toInt(pixel)];
        };
