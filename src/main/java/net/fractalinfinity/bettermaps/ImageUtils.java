...
public class ImageUtils {
    ...
    {initcolortree();createcolorcashe();colormodel = createCustomColorModel(colorslist);
    ...
    public static void  writepng8(BufferedImage image,File out) throws IOException {
        BufferedImage indexedImage = new BufferedImage(128, 128, BufferedImage.TYPE_BYTE_INDEXED, colormodel);
